...
const customFields = {
    ...
    ).trim().min(4).max(8).messages({ "string.pattern.base": "Password must be atleast 4 characters long, with a mix of uppercase, lowercase, number and special characters" }).required()
};
